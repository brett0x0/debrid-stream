...
export class Deduplicator {
   ...
   */
  public static deduplicate(candidates: TorrentCandidate[]): TorrentCandidate[] {
    const seenHashes = new Map<string, TorrentCandidate>();
    const result: TorrentCandidate[] = [];
    ...
    const fingerprinted = new Map<string, TorrentCandidate>();
    const finalCandidates: TorrentCandidate[] = [];
