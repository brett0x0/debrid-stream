export const PATTERNS = {
  resolution: [
    { pattern: /\b(?:2160p|4k|uhd)\b/i, value: '2160p' as const },
    { pattern: /\b(?:1080p|1080i|fhd)\b/i, value: '1080p' as const },
    { pattern: /\b(?:720p|hd)\b/i, value: '720p' as const },
    { pattern: /\b(?:480p|576p|sd)\b/i, value: '480p' as const },
  ],

  source: [
    { pattern: /\b(?:bdremux|remux)\b/i, value: 'REMUX' as const },
    { pattern: /\b(?:bluray|blu-ray|bdrip|brrip)\b/i, value: 'BluRay' as const },
    { pattern: /\b(?:web-dl|webdl)\b/i, value: 'WEB-DL' as const },
    { pattern: /\b(?:web-rip|webrip|web)\b/i, value: 'WEBRip' as const },
    { pattern: /\b(?:hdtv|pdtv|dsr)\b/i, value: 'HDTV' as const },
    { pattern: /\b(?:cam|camrip|hdcam|ts|telesync|hdts)\b/i, value: 'CAM' as const },
  ],

  codec: [
    { pattern: /\b(?:av1)\b/i, value: 'AV1' as const },
    { pattern: /\b(?:x[._-]?265|h[._-]?265|hevc)\b/i, value: 'HEVC' as const },
    { pattern: /\b(?:x[._-]?264|h[._-]?264|avc)\b/i, value: 'AVC' as const },
    { pattern: /\b(?:xvid|divx)\b/i, value: 'XVID' as const },
  ],
